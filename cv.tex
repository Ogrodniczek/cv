...
\cventry{2017.03--2017.12}{Senior Software Engineer}{Intive}{}{}{
    Goal of this project was to automate tasks that were performed manually, like building process, release notes generation basing on multiple sources etc. Second part of the project was to perform DevOps activities (CI and Docker related) for a micro-serviced application.
\begin{itemize}
...
\cvitem{Cloud computing \& containers}{
        Amazon Web Services, Eucalyptus, RIAK (S3),
